...
if (isset($_POST['admin'])) {
	...
	$sql = "insert into rental_mobil_kostumer values ('', '$user', '$nama', '$alamat', '$jk', '$hp', '$ktp')";
	echo $sql;
	$query = mysqli_query($db_link, $sql);
	if ($query) {
		header('Location: index.php');
	} else {
		header("Location: addkostumer.php?msg=password+dengan+confirm+password+tidak+sesuai");
	}
}
?>
<!doctype html>
